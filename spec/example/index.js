...
"use strict";function getVault(t,e,r,n){var o={read:{include_docs:!0}};if(n){var u=pbkdf2sha512_1.default(n.pbkdf2);o.hash=getHash(u),o.bins=n.bins}return cbox_vault_1.default(t,e,getKeyRing(r),o)}function getHash(t){return function(e){return t(e).then(function(t){return t.value})}}function getKeyRing(t){return{auth:t.key,cipher:t.key}}Object.defineProperty(exports,"__esModule",{value:!0});var account_stream_operators_1=require("./account-stream-operators"),pbkdf2sha512_1=require("pbkdf2sha512"),cbox_vault_1=require("cbox-vault"),zenypass_account_model_1=require("zenypass-account-model"),rxjs_1=require("rxjs"),tslib_1=require("tslib"),VAULT_SERVICE_SPEC_DEFAULTS={getAccountFactory:zenypass_account_model_1.default},_VaultService=function(){function t(t,e,r){this.vault=t,this.newAccount=e,this.operators=r}return t.prototype.write=function(t){var e=this.operators.fromAccount(rxjs_1.Observable.from(t)),r=rxjs_1.Observable.from(this.vault).concatMap(function(t){return t.write(e)}),n=this.operators.toAccount(r);return n},t.prototype.read=function(t,e){var r=rxjs_1.Observable.from(this.vault).concatMap(function(e){return e.read(t)}),n=this.operators.toAccount(r);return n},t.prototype.unlock=function(e){var r=Promise.all([this.vault,e]).then(function(t){var e=t[0],r=t[1];return e.unlock(getKeyRing(r))});return new t(r,this.newAccount,this.operators)},t.prototype.toVaultService=function(){var t=this;return{newAccount:t.newAccount.bind(t),write:t.write.bind(t),read:t.read.bind(t),unlock:function(e){return t.unlock(e).toVaultService()}}},t}();_VaultService.getInstance=function(t,e,r,n){function o(t){return i.then(function(e){return e.unlock(t)}).then(Boolean)}var u=tslib_1.__assign({},VAULT_SERVICE_SPEC_DEFAULTS,n),a=Promise.resolve(r),c=u.vault?Promise.resolve(u.vault):Promise.all([a,u.encoder]).then(function(r){var n=r[0],o=r[1];return getVault(t,e,n,o)}),i=a.then(function(t){return t.clone()}),s=u.getAccountFactory.bind(void 0,o),l=account_stream_operators_1.default(s);return new _VaultService(c,l.newAccount,l).toVaultService()};var getVaultService=_VaultService.getInstance;exports.default=getVaultService;
