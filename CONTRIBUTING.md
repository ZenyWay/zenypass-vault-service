# Contributing to zenypass-vault-service
...
[zenypass-vault-service Gitter channel](https://gitter.im/ZenyWay/zenypass-vault-service).

## <a name="issues"></a> Issues
### Security issues
For the security of the community relying on zenypass-vault-service,
...
are tracked as GitHub [issues in this repository](https://github.com/ZenyWay/zenypass-vault-service/issues):
* please either [submit a new issue](https://github.com/ZenyWay/zenypass-vault-service/issues/new)
...
**zenypass-vault-service version:** (only for issues) first version of zenypass-vault-service affected by the issue
...
* a PR must close at least one [open issue](https://github.com/ZenyWay/zenypass-vault-serviceg/issues?utf8=%E2%9C%93&q=is%3Aissue+is%3Aopen).
The corresponding issues should be listed in the title of the PR,
e.g. "close #21, #42".
* all PRs must pass the full zenypass-vault-service test suite and
...
https://github.com/ZenyWay/zenypass-vault-service/blob/master/ICLA.
```
This is required both in the contributor's own interest,
and that of the community relying on this project,
...
#### CI
CI testing runs on [TravisCI](https://travis-ci.org/ZenyWay/zenypass-vault-service).
